...
class series_draw_area(PySide2.QtWidgets.QGraphicsView):

    class __populate_scene_thread(PySide2.QtCore.QThread):
    
        class __term_graphics_item(PySide2.QtWidgets.QGraphicsRectItem):
        
            def __init__(self,x,y,w,h,pen,brush,parent=None):
                PySide.QtWidgets.QGraphicsRectItem.__init__(self,x,y,w,h,parent)
                self.setPen(pen)
                self.setBrush(brush)
            ...
            def hoverEnterEvent(self,event):
                new_pen = PySide2.QtGui.QPen(PySide.QtCore.Qt.yellow)
                new_pen.setStyle(PySide2.QtCore.Qt.DotLine)
                self.setPen(new_pen)
                self.setZValue(1)
        ...
        def __init__(self,cwidth,parent):
            PySide2.QtCore.QThread.__init__(self,parent)
        ...
        def run(self):
            ...
            brush_tuple = (PySIde2.QtGui.QBrush(PySide2.QtCore.Qt.darkRed), PySIde2.QtGui.QBrush(PySide2.QtCore.Qt.darkGreen))
            pen = PySide2.QtGui.QPen(PySide2.QtCore.Qt.NoPen)
            self.__n = 0
            ...
            for i in self.__series.index0:
                ...
                if not (self.__n & (256 - 1)):
                    PySide2.QtCore.QObject.emit(self,PySide2.QtCore.SIGNAL("step(int)"),self.__n)
                self.__n += 1
            self.__series_graphics_scene.moveToThread(PySide2.QtCore.QCoreApplication.instance().thread())
    ...
    def __init__(self, parent):
        PSide2.QtWidgets.QGraphicsView.__init__(self,parent)
        self.__series_name = None
        self.__series = None
        self.__series_graphics_scene = None
        self.__progress_bar = None
        self.__mutex = PySide2.QtCore.QMutex()
        self.setAlignment(PySide2.QtCore.Qt.AlignLeft | PySide2.QtCore.Qt.AlignBottom)
        # Default column width.
        self.__cwidth = 10
        self.__populator_thread = self.__populate_scene_thread(self.__cwidth,self)
        self.connect(self.__populator_thread, PySide2.QtCore.SIGNAL("finished()"),self.__slot_population_finished)
    ...
    def __slot_population_finished(self):
        ...
        if top_value != 0:
            ...
            self.setMatrix(PySide2.QtGui.QMatrix(x_scale_factor,0,0,-y_scale_factor,0,0))
            self.setScene(self.__series_graphics_scene)
        self.__progress_bar.setVisible(False)
        self.disconnect(self.__populator_thread,PySide2.QtCore.SIGNAL("step(int)"),self.__progress_bar.setValue)
        self.__set_busy(False)
    ...
    def __populate_scene(self):
        ...
        if not self.__series or len(self.__series) == 0:
            return
        self.__series_graphics_scene = PySide2.QtWidgets.QGraphicsScene()
        ...
        self.connect(self.__populator_thread, PySide2.QtCore.SIGNAL("step(int)"),self.__progress_bar.setValue)
    ...
    def __is_busy(self):
        PySided2.QtCore.QMutexLocker(self.__mutex)
        return self.__busy
        
    def __set_busy(self,value):
        PySide2.QtCore.QMutexLocker(self.__mutex)
        self.__busy = value
