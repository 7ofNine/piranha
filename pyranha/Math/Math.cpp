...
PYBIND11_MODULE(_Math, m)
{
    ...
    m.def("besselJ", jn_real(&besselJ),
            "Bessel function of the first kind of integer order and real double-precision argument.");
    m.def("dbesselJ", jn_real(&dbesselJ),
            "First derivative of the Bessel function of the first kind of integer order and real double-precision argument.");
    m.def("besselI", &besselI, "Modified Bessel function of the first kind of integer order.");
    m.def("legendrePnm", &legendrePnm, "Associated Legendre function.");
    m.def("legendrePn", &legendrePn, "Legendre polynomial.");
    ...
    m.def("Ynm", Ynm_plain(&Ynm), "Spherical harmonic (not normalised).");
    m.def("Ynm", Ynm_ei_plain(&Ynm), "Spherical harmonic (not normalised).");
    m.def("Ynm", Ynm_rot(&Ynm), "Rotated spherical harmonic (not normalised).");
    m.def("Ynm", Ynm_ei_rot(&Ynm), "Rotated spherical harmonic (not normalised).");
    
    // Factorial.
    typedef double (*factorial_double)(const int &);
    typedef mp_integer (*factorial_mp)(const mp_integer &);
    m.def("__factorial", factorial_double(&factorial), "Factorial (double-precision).");
    m.def("__factorial", factorial_mp(&factorial), "Factorial (arbitrary precision).");
    
    // Double factorial.
    typedef mp_integer (*double_factorial_mp)(const mp_integer &);
    typedef double (*double_factorial_double)(const int &);
    m.def("__double_factorial", double_factorial_mp(&double_factorial), "Double factorial of non-negative integer argument.");
    m.def("__double_factorial", double_factorial_double(&double_factorial), "Double factorial of non-negative integer argument.");
    ...
    m.def("__r_factorial", r_factorial_complex_double(&r_factorial), "Rising factorial.");
    m.def("__r_factorial", r_factorial_double(&r_factorial), "Rising factorial.");
    m.def("__r_factorial", r_factorial_mp_int(&r_factorial), "Rising factorial.");
    m.def("__r_factorial", r_factorial_mp_rat(&r_factorial), "Rising factorial.");
    ...
    m.def("__f_factorial", f_factorial_complex_double(&f_factorial), "Falling factorial.");
    m.def("__f_factorial", f_factorial_double(&f_factorial), "Falling factorial.");
    m.def("__f_factorial", f_factorial_mp_int(&f_factorial), "Falling factorial.");
    m.def("__f_factorial", f_factorial_mp_rat(&f_factorial), "Falling factorial.");
    ...
    m.def("__choose", c_choose_double_double(&choose), "Binomial coefficient (complex double-precision).");
    m.def("__choose", c_choose_double(&choose), "Binomial coefficient (complex double-precision).");
    m.def("__choose", choose_double_double(&choose), "Binomial coefficient (double-precision).");
    m.def("__choose", choose_double(&choose), "Binomial coefficient (double-precision).");
    m.def("__choose", choose_z(&choose), "Binomial coefficient (multiprecision integer).");
    m.def("__choose", choose_q(&choose), "Binomial coefficient (multiprecision rational).");
    ...
    m.def("cs_phase", cs_int(&cs_phase), "Condon-Shortley phase = (-1)**arg1.");
    m.def("cs_phase", cs_z(&cs_phase), "Condon-Shortley phase = (-1)**arg1.");
}
