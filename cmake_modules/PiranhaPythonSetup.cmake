...
MACRO(PIRANHA_PYTHON_SETUP)
  ...
  IF(${PYTHON_LIBRARY_VERSION} GREATER 24 AND MINGW)
    MESSAGE(STATUS "Python >= 2.5 detected on MinGW platform. Output extension for compiled modules will be '.pyd'.")
    SET(PYDEXTENSION TRUE)
  ENDIF(${PYTHON_LIBRARY_VERSION} GREATER 24 AND MINGW)
  # Trick to locate python's modules directory
  IF(MINGW)
    STRING(REGEX REPLACE "libs/libpython.*" "DLLs/" PYTHON_MODULES_PATH ${PYTHON_LIBRARY})
  ELSE(MINGW)
    STRING(REGEX REPLACE "libpython.*" "site-packages/" PYTHON_MODULES_PATH ${PYTHON_LIBRARY})
  ENDIF(MINGW)
