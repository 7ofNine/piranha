...
EXECUTE_PROCESS(COMMAND ${GIT_BIN} --git-dir=${CMAKE_SOURCE_DIR}/.git log -1 --abbrev-commit --pretty=oneline COMMAND
	${AWK_BIN} -F "." "{print $1}" RESULT_VARIABLE RETVAL
	OUTPUT_VARIABLE PIRANHA_REV_NUMBER OUTPUT_STRIP_TRAILING_WHITESPACE)
...
MESSAGE(STATUS "Revision number: ${PIRANHA_REV_NUMBER}")
