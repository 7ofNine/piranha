...
namespace piranha
{
	...
	class CountingAllocator: public base_counting_allocator
	{
		...
		public:
			...
			template <class U>    // is that used anywhere ??????
			struct rebind {
	...
	****************************************************************************/
	 ...
	 */
//	template <class T, int Alignment>                            // TODO: this allocator is nowhere used. Remove. Do we need alignmenet or are modern std types O.K.??
