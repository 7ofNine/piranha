...
#define POISSON_SERIES_DEGREE            typename POISSON_SERIES_TERM::cf_type::TermType::key_type::degree_type
...
#define COMPLEX_POISSON_SERIES_DEGREE typename COMPLEX_POISSON_SERIES_TERM::cf_type::TermType::key_type::degree_type
