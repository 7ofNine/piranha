...
#define POISSON_SERIES_DEGREE            typename POISSON_SERIES_TERM::CfType::TermType::KeyType::degree_type
...
#define COMPLEX_POISSON_SERIES_DEGREE typename COMPLEX_POISSON_SERIES_TERM::CfType::TermType::KeyType::degree_type
