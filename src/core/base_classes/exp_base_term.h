...
#ifndef PIRANHA_EXP_BASE_TERM_H
#define PIRANHA_EXP_BASE_TERM_H
...
#define PIRANHA_EXP_BASE_TERM_TP_DECL class Cf, class Key, char Separator, class Derived
#define PIRANHA_EXP_BASE_TERM_TP Cf, Key, Separator, Derived

namespace piranha
{
	class ExpBaseTermTag {}; 

	//template <char Separator, typename Derived>
	//class BaseTermBase : public BaseTermTag {};
	...
	class ExpBaseTerm : public ExpBaseTermTag
	{
	public:
		...
		//
		ExpBaseTerm() = default;
		ExpBaseTerm(ExpBaseTerm const &) = default;
		ExpBaseTerm(ExpBaseTerm &&) = default;
		...
		ExpBaseTerm(const CfType & cf, const KeyType & key) : cf(cf), key(key) {};
	...
	// this is used in monomial and fourier_Series_term
	//
...
#undef PIRANHA_EXP_BASE_TERM_TP_DECL
#undef PIRANHA_EXP_BASE_TERM_TP
