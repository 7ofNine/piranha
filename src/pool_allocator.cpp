...
// Definitions for pool_allocator_base.
  template <int Alignment>
    pool_allocator_base<Alignment>::_Obj* volatile*
...
// Build free list in chunk.
  ...
  template <int Alignment>
    pool_allocator_base<Alignment>::_Obj* volatile pool_allocator_base<Alignment>::_S_free_list[_S_free_list_size];
...
// Instantiations.
  template class pool_allocator<char>;
  template class pool_allocator<wchar_t>;
}
