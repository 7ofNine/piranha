...
namespace piranha
  ...
  template <class Cf,class Trig,template <class,class> class I>
  inline void base_pseries<Cf,Trig,I>::read_lin_args(std::ifstream &inf)
  {
    std::string temp;
    deque_string split_v;
    std::streampos cur_pos=inf.tellg();
  ...
  // Read terms.
  template <class Cf,class Trig,template <class,class> class I>
  inline void base_pseries<Cf,Trig,I>::read_terms(std::ifstream &inf,const std::string &filename)
  {
    phase_list pl;
        ...
        else
          {
            ...
            switch (pl.operation())
              ...
              case phase_list::add
                ...
                break;
              default:
                add_phase_to_term(*it_pl-new_term.phase(trig_s_vec_),new_term,tmp_term,*this);
              }
            ++it_pl;
          }
      }
  ...
  // Identify section
  template <class Cf,class Trig,template <class,class> class I>
  inline void base_pseries<Cf,Trig,I>::identify_sections(std::ifstream &inf,const std::string &filename)
  {
    std::string temp;
    while (utils::get_valid_string(inf,temp)==0)
      {
  ...
  // Read data
  template <class Cf,class Trig,template <class,class> class I>
  inline void base_pseries<Cf,Trig,I>::read_data_from_file(std::ifstream &inf,
  ...
  template <class Cf,class Trig,template <class,class> class I>
  inline void base_pseries<Cf,Trig,I>::load_from(const std::string &fn)
  {
    std::ifstream inf;
  ...
  /// Save series to file.
  template <class Cf,class Trig,template <class,class> class I>
  inline void base_pseries<Cf,Trig,I>::save_to(const std::string &filename) const
    {
