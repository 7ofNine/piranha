...
import sys,time
import PyQt4.QtCore, PyQt4.QtCore
...
class panelWidget(PyQt4.QtGui.QWidget,Ui_panelWidget):
	def __init__(self,parent = None):
		...
		self.fpComboBox.addItem("Scientific")
		self.fpComboBox.addItem("Decimal")
		...
		#self.connect(self.ui.theoriesPathLineEdit,QtCore.SIGNAL("textChanged(const QString &)"),self.__setTheoriesPath)
	...
	#def __setTheoriesPathDialog(self):
		...
		#dialog.setWindowTitle("Select path to add")
