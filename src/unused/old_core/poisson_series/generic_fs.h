...
namespace piranha
{
   ...
   */
  template <class Cf, class Trig, template <class,class,class> class Term,
    template <class> class I, class Allocator=std::allocator<char> >
    class generic_fs:
...
namespace std
{
  ...
  template <class Cf, class Trig, template <class,class,class> class Term,
    template <class> class I, class Allocator>
